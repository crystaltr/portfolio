    ...
    const [showContentTwo, setShowContentTwo] = useState(false);
     {
        return (
            <div className='proj-grid'>
                ...
                <h2>Discovery</h2>
                <p>
                    Before I was placed on the project a portal redesign user testing was done. From the testing, many participants voiced concern for the lack of features available in the payments page. 
                ...
                <img src={paysearch} alt="paysearch" style={{width: '90%'}}/><br/>
                ...
                The page was split into three parts: payments, payment history and statements. < br/>
                ...
                <img src={payiter} alt="payiter" style={{width: '90%'}}/><br/>
                <h2>Handover</h2>
                <p>
                ...
                An important part of the processes was the walkthroughs after the developers have completed their work. 
                The developers showcased the pages while I checked if there was anything missing or irregular. 
                ...
                <div class='tdlr-container'>
                     <h2>Discovery</h2>
                        ...
                        From here, I was able to start my competitor analysis and create wireframes to address all cases a user may encounter.
                        </p>
                        <img src={paysearch} alt="paysearch" style={{width: '90%'}}/><br/>
                <h2>Design iterations</h2>
                <p>
                The big changes made were: < br/>
                - Remove breadcrumbs and instead split the one page into three sections; payments, payment history and statements < br/>
